...
const StudentList = () => {
  ...
  return (
    <div className="container">
      <hr />
      <form onSubmit={addToList} className="w-60 mx-auto">
        <div className=" d-block pt-8">
          ...
          <button
            type="submit"
            className=" btn btn-primary mt-5  p-3 w-100 d-block mx-auto"
          >
            Add new Student
          </button>
        </div>
      ...
      <br />
      <div className="mt-5 text-center"> All Students 🏫</div>
